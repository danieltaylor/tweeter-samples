...
public class FollowingServiceProxyTest {
    ...
    /**
     * Verify that for requests the {@link FollowingServiceProxy#getFollowees(FollowingRequest)}
     * method returns a valid response when integrated with a real {@link ServerFacade}.
     *
     * @throws IOException if an IO error occurs.
     */
    @Test
    public void testGetFollowees_integration() throws IOException, TweeterRemoteException {
        FollowingServiceProxy integratedProxy = new FollowingServiceProxy();
        FollowingResponse response = integratedProxy.getFollowees(validRequest);
