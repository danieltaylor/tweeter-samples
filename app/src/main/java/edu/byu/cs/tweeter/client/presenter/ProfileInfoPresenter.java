...
import edu.byu.cs.tweeter.client.model.service.ProfileInfoServiceProxy;
...
public class ProfileInfoPresenter {
     ...
     */
    public ProfileInfoResponse getProfileInfo(ProfileInfoRequest profileInfoRequest) throws IOException, TweeterRemoteException {
    ...
    ProfileInfoService getProfileInfoService() {
        return new ProfileInfoServiceProxy();
    }
}
