 ...
 * statuses for a specified user's followees.
 */
public class FeedRequest {
     ...
     * Creates an instance.
     *
     * @param user the {@link User} whose followees' statuses are to be returned.
    ...
    /**
     * Returns the user whose followees' statuses are to be returned by this request.
     *
     * @return the user.
     */
    public User getUser() {
