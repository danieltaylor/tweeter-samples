 ...
 */
public class LiteFollowingResponse extends PagedResponse {
	 ...
	 */
	public LiteFollowingResponse(String message) {
	 ...
	 */
	public LiteFollowingResponse(List<String> followees, boolean hasMorePages) {
	...
	public boolean equals(Object param) {
		...
		LiteFollowingResponse that = (LiteFollowingResponse) param;
