...
public class FollowingDAO {
     ...
     *
     * @param follower the user who is or is not doing the following.
     * @param followee the user who is or is not being followed.
    ...
    /**
     * Adds a user to another user's list of followees.
     *
    ...
    /**
     * Removes a user from another user's list of followees.
     *
     * @return response indicating success or failure.
     */
